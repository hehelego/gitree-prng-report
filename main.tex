...
Here, we following the recipe in by Stepanenko et al.~\cite{esop25git-callcc} to model the PRNG effects.
  ...
  \begin{enumerate}
    ...
    \item Case \(f(init) = \mathbf{F}\).
      ...
      \[
        ...
        \end{array}
      \]
      Apply the induction hypothesis, which becomes available since we go under a later modality, to complete the proof.
  \end{enumerate}
\end{proof}
